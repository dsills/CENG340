...
```{r}
setwd("/Users/Deborah/desktop/CENG340/grade_dist/Midterm1")
...
```{r}
#To import data
abc <- read.table('midterm1.csv', header=FALSE, sep=',')
colnames(abc)<- "grades"
```
...
ggplot(abc, aes(x=grades)) + geom_histogram(binwidth = 0.75, fill = "#CC0000") +
